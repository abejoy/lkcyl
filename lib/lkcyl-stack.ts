  ...
  constructor(scope: Construct, id: string, props: cdk.StackProps) {
    ...
    const emailBucket = new s3.Bucket(this, bucketName, {
      ...
      blockPublicAccess: new BlockPublicAccess({
        // Correctly disables all block public access settings
    ...
    const roleForEmailLambdaPolicy = new iam.ManagedPolicy(
      this,
      `${id}EmailLambdaPolicy`,
      {
        statements: [
          ...allowLogs,
          new iam.PolicyStatement({
    ...
    //lambda
    const emailLambdaFunction = new NodejsFunction(
      this,
      `${id}SendEmailLambda`,
      {
    ...
    //lambda
    const teamLambdaFunction = new NodejsFunction(
      this,
      `${id}GetTeamDataLambda`,
      {
        runtime: Runtime.NODEJS_18_X,
        handler: "index.handler",
